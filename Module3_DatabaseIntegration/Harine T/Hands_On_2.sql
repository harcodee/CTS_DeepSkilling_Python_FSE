...
INSERT INTO professors (prof_name, email, department_id, salary) VALUES
 ...
 -- inserting 2 additional students
...
('Anjali', 'Reddy', 'anjali.reddy@college.edu', '2004-02-10', 3, 2023);

-- updation of grade
UPDATE enrollments
SET grade = 'B'
WHERE student_id = 5 AND course_id = 1 AND grade ='C';

-- deleting null grades
SELECT *
FROM enrollments
WHERE grade IS NULL;
...
SELECT CONCAT( first_name,' ',last_name) AS student_name, dept_name
...
-- ==========================================
 ...
 ON e.course_id = c.course_id WHERE c.course_code = "CS101"
 GROUP BY e.grade;
 
 SELECT d.dept_name, COUNT(DISTINCT e.student_id) AS total_students
